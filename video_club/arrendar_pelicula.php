...
<div class="medium-6 medium-centered large-4 large-centered columns">
    ...
    <form action="#" method="post" >
      <div class="row column log-in-form">
        <h4 class="text-center">ARRIENDA TU PELICULA</h4>
         <label>Cod. pelicula
        ...
        <input type="submit" name="b_ingresar" id="b_ingresar" value="ALQUILAR" class="button expanded" onclick="menos_js()">
	...
	$vl_cod_pelicula = $_REQUEST["cod_pelicula"];
	if ($vl_cod_pelicula <> ''){
		echo "<script type='text/javascript'>
	document.getElementById('cod_pelicula').value = $vl_cod_pelicula;
	cod_peli_js($vl_cod_pelicula);
	function nuevoAjax(){
	var xmlhttp=false;
	try{
...
function menos_js(){
	...
	var vl_cant_actual = vl_cant_ant - 1;
